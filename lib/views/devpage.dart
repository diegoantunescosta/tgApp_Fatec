...
import 'package:flutter_social/widgets/feed_card_dev.dart';
...
class _DevPageState extends State<DevPage> {
  Widget build(BuildContext context) {
    final List<Dev> testes = [
      Dev(
          id: 1,
          name: 'Diego Antunes da Costa ',
          image:
              'https://media-exp1.licdn.com/dms/image/C4D03AQH_fUZnBg2m4A/profile-displayphoto-shrink_200_200/0/1630012250797?e=1654128000&v=beta&t=37z-IeFINXGJSC3QdHs2b3A1KjTs-2TPjkYGhU0fQSE',
          describe: 'Aluno 6º termo Fatec Shunji Nishimura'),
      Dev(
          id: 2,
          name: 'Fernada Maria Pereira Miranda',
          image:
              'https://media-exp1.licdn.com/dms/image/C4E03AQFWbpx-W37lcA/profile-displayphoto-shrink_800_800/0/1645017940572?e=1654128000&v=beta&t=Myl7Gs7fLL_RJh5i8GGSD5xdg4RnWyO2nY0pyCS7tVo',
          describe: 'Aluna 6º termo Fatec Shunji Nishimura'),
      Dev(
          id: 3,
          name: 'Iam Caio',
          image:
    ...
    return Scaffold(
      appBar: AppBar(
          title: const Text('Equipe de Desenvolvimento'),
            ...
            children: <Widget>[
              Container(
                padding: EdgeInsets.only(
                    top: 60.0, left: 30.0, right: 30.0, bottom: 150.0),
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: <Widget>[
                    FeedCardDev(
